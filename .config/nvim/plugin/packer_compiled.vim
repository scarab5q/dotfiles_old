...
_G.packer_plugins = {
  ale = {
    ...
    loaded = false,
    needs_bufread = true,
    path = "/home/jack/.local/share/nvim/site/pack/packer/opt/ale"
  },
  ["colorbuddy.vim"] = {
    loaded = true,
    path = "/home/jack/.local/share/nvim/site/pack/packer/start/colorbuddy.vim"
  },
  ["completion-nvim"] = {
    after = { "vim-vsnip-integ", "vim-vsnip" },
    loaded = false,
    needs_bufread = false,
    path = "/home/jack/.local/share/nvim/site/pack/packer/opt/completion-nvim"
  },
  dracula = {
    loaded = true,
    path = "/home/jack/.local/share/nvim/site/pack/packer/start/dracula"
  },
  firenvim = {
    loaded = true,
    path = "/home/jack/.local/share/nvim/site/pack/packer/start/firenvim"
  },
  ["galaxyline.nvim"] = {
    config = { "\27LJ\2\n*\0\0\3\0\2\0\0046\0\0\0'\2\1\0B\0\2\1K\0\1\0\15statusline\frequire\0" },
    loaded = true,
    path = "/home/jack/.local/share/nvim/site/pack/packer/start/galaxyline.nvim"
  },
  ["gitsigns.nvim"] = {
  ...
  ["markdown-preview.nvim"] = {
    ...
    loaded = false,
    needs_bufread = false,
    path = "/home/jack/.local/share/nvim/site/pack/packer/opt/markdown-preview.nvim"
  },
  ["nvim-treesitter"] = {
    loaded = true,
  ...
  ["vim-matchup"] = {
    after_files = { "/home/jack/.local/share/nvim/site/pack/packer/opt/vim-matchup/after/plugin/matchit.vim" },
    loaded = false,
    needs_bufread = true,
    path = "/home/jack/.local/share/nvim/site/pack/packer/opt/vim-matchup"
  },
  ["vim-surround"] = {
    loaded = true,
  ...
  ["vim-vsnip"] = {
    ...
    loaded = false,
    needs_bufread = false,
    path = "/home/jack/.local/share/nvim/site/pack/packer/opt/vim-vsnip"
  },
  ["vim-vsnip-integ"] = {
    after_files = { "/home/jack/.local/share/nvim/site/pack/packer/opt/vim-vsnip-integ/after/plugin/vsnip_integ.vim" },
    load_after = {
      ["completion-nvim"] = true
    },
    loaded = false,
    needs_bufread = false,
    path = "/home/jack/.local/share/nvim/site/pack/packer/opt/vim-vsnip-integ"
  }
}
