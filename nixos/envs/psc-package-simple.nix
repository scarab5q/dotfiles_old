...
in pkgs.stdenv.mkDerivation rec {
  ...
  src =
    if pkgs.stdenv.isDarwin then
      pkgs.fetchurl {
        url =
          "https://github.com/purescript/psc-package/releases/download/v0.5.1/macos.tar.gz";
        sha256 =
          "0h9n86kydxpa4qvkvf078zjqxazwxv9pvasf2rq7avdhr1asnppi";
      }
    else
      pkgs.fetchurl {
        url =
          "https://github.com/purescript/psc-package/releases/download/v0.5.1/linux64.tar.gz";
        sha256 =
          "0nffiqhfdfkg0i9hgz3vhnjrwsb4gg912rmsn2gdfgbh1m44k5df";
      };
  ...
  installPhase =
    ...
    ''
    + pkgs.stdenv.lib.optionalString
