...
pkgs.stdenv.mkDerivation rec {
  ...
  src =
    if pkgs.stdenv.isDarwin then
      pkgs.fetchurl {
        url =
          "https://github.com/coot/zephyr/releases/download/v0.2.1/macos.tar.gz";
        sha256 =
          "0zwdsrs7r6ff534wrar32lk39fjai1jj4dxz4bjh3yhw63lvdqfn";
      }
    else
      pkgs.fetchurl {
        url =
          "https://github.com/coot/zephyr/releases/download/v0.2.1/linux64.tar.gz";
        sha256 =
          "0afcnpqabjs4b60grkcvz2hb3glpjhlnvqvpgc0zsdwaqnmcrrnk";
      };
